...
export const SafetyMeasures: React.FC<SafetyMeasuresProps> = ({ config }) => {
  ...
  return (
    <div className="px-4 py-6">
      <h2 className="text-lg sm:text-xl font-semibold mb-4">100% Safe & Secure Lab Tests</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        {config.measures.map((measure) => (
          <div key={measure.id} className="bg-blue-50 rounded-lg p-4 hover:bg-blue-100 transition-colors">
